...
func newOpsHandler(t *testing.T, exec OpsExecutor) *Handler {
	...
	h, err := New(Config{ClusterName: "orders", Namespace: "payments", EventsWindow: time.Hour, AllowOperations: true, LevelHeader: "X-PgToolBox-Level"},
		Sources{Cluster: staticSnapshots{}, Pods: staticSnapshots{}, Events: staticSnapshots{}, Backups: staticSnapshots{}, Poolers: staticSnapshots{}, FailoverQuorum: staticSnapshots{}, ImageCatalogs: staticSnapshots{}},
